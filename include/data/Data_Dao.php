...
class Data_Dao
{
     ...
     * @param boolean $keepOrder 是否保持$pkValues顺序
	 * @return array
	 */
	public function getList(array $pkValues, $keepOrder=false)
	{
		...
		if ($keepOrder && $this->_pk) {
		    $this->_order = sprintf("ORDER BY FIELD(%s,%s)",$this->_pk,implode(",", $pkValues));
        }
